...
class QuestionnaireRepository(private val questionnaireDAO: QuestionnaireDAO) {
    fun getByCategory(category: String): Flow<List<Question>> = questionnaireDAO.getByCategory(category).map { list ->
